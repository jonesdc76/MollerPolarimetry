...
int LowPassRampPlot2(){
  TCanvas *c = new TCanvas("c","c",0,0,1600,900);
  c->Divide(3,2);
  c->cd(1);
  TGraph *gr1 = new TGraph("~/Downloads/FeFoilNoAn2Aux1RampDown4.5to0TLowPassFilter031621.txt","%*lg, %lg, %lg");
  scale(gr1);
  ...
  TGraph *gr2 = new TGraph("~/Downloads/FeFoilNoAn2Aux1RampDown2ndTime4.5to0TLowPassFilter031621.txt","%*lg, %lg, %lg");
  scale(gr2);
  ...
  lg->AddEntry(gr1,"1st Ramp Down","lp");
  lg->AddEntry(gr2,"2nd Ramp Down","lp");
  lg->Draw();
  c->cd(2);
  TGraph *gr3 = new TGraph("~/Downloads/FeFoilNoAn2Aux1RampDown4.5to0TLowPassFilter031621.txt","%*lg, %lg, %*lg, %*lg, %lg");
  //norm(gr3);
  ...
  TGraph *gr4 = new TGraph("~/Downloads/FeFoilNoAn2Aux1RampDown2ndTime4.5to0TLowPassFilter031621.txt","%*lg, %lg, %*lg, %*lg, %lg");
  //norm(gr4);
  ...
  lg->Draw();
  c->cd(4);
  TGraph *gr5 = new TGraph("~/Downloads/FeFoilNoAn2Aux1RampDown4.5to0TLowPassFilter031621.txt","%*lg, %lg, %*lg, %*lg, %*lg, %*lg, %lg");
  scale(gr5);
  ...
  TGraph *gr6 = new TGraph("~/Downloads/FeFoilNoAn2Aux1RampDown2ndTime4.5to0TLowPassFilter031621.txt","%*lg, %lg, %*lg, %*lg, %*lg, %*lg, %lg");
  scale(gr6);
  ...
  c->cd(5);
  TGraph *gr7 = new TGraph("~/Downloads/FeFoilNoAn2Aux1RampDown4.5to0TLowPassFilter031621.txt","%*lg, %lg, %*lg, %*lg, %*lg, %*lg, %*lg, %*lg, %lg");
  //scale(gr7);
  ...
  TGraph *gr8 = new TGraph("~/Downloads/FeFoilNoAn2Aux1RampDown2ndTime4.5to0TLowPassFilter031621.txt","%*lg, %lg, %*lg, %*lg, %*lg, %*lg, %*lg, %*lg, %lg");
  //scale(gr8);
